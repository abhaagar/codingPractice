...
int main() {
   ...
   cout << "store Id : " << sm.addStore("bangalore","karnataka") << std::endl;
   cout << "store Id : " << sm.addStore("meerut","up") << std::endl;
   sm.addItemInStore(0,"Poha",5); 
   std::cout <<sm.stockLeftOfItem(0,"Poha") << "\n";
   sm.removeItemInStore(0,"Poha",5); 
   std::cout <<sm.stockLeftOfItem(0,"Poha") << "\n";
   sm.addItemInStore(1,"Poha",5); 
   sm.removeItemInStore(1,"Poha",5); 
